...
void test_BF (void)
{
    ...
    for (int k = 0 ; k < 1; k++)
    {
        ...
        fprintf (stdout, "transpose     time: %g\n", transpose_time) ;
        ...
        for (int kk = 1 ; kk <= ktrials ; kk++)
        {
            ...
            t5 = t5 / ntrials;
            fprintf (stdout, "BF_full1      time: %12.6e (sec), rate:"
            ...
            t5a = t5a / ntrials;
            fprintf (stdout, "BF_full1a     time: %12.6e (sec), rate:"
            ...
            t6 = t6 / ntrials;
            fprintf (stdout, "BF_full2      time: %12.6e (sec), rate:"
            ...
            t1 = t1 / ntrials;
            fprintf (stdout, "BF_full       time: %12.6e (sec), rate:"
                " %g (1e6 edges/sec)\n", t1, 1e-6*((double) nvals) / t1) ;
            fprintf (stdout, "t(BF_full1) / t(BF_full):      %g\n", t5/t1) ;
            ...
            t2 = t2 / ntrials;
            fprintf (stdout, "BF_basic      time: %12.6e (sec), rate:"
                " %g (1e6 edges/sec)\n", t2, 1e-6*((double) nvals) / t2) ;
            fprintf (stdout, "speedup of BF_basic:       %g\n", t1/t2) ;
            ...
            t3 = t3 / ntrials;
            fprintf (stdout, "BF_pure_c_double  : %12.6e (sec), rate:"
                " %g (1e6 edges/sec)\n", t3, 1e-6*((double) nvals) / t3) ;
            fprintf (stdout, "speedup of BF_pure_c:      %g\n", t1/t3) ;
            ...
            t4 = t4 / ntrials;
            fprintf (stdout, "BF_full_mxv   time: %12.6e (sec), rate:"
                " %g (1e6 edges/sec)\n", t4, 1e-6*((double) nvals) / t4) ;
            fprintf (stdout, "speedup of BF_full_mxv:    %g\n", t1/t4) ;
            ...
            t7 = t7 / ntrials;
            fprintf (stdout, "BF_basic_mxv  time: %12.6e (sec), rate:"
                " %g (1e6 edges/sec)\n", t7, 1e-6*((double) nvals) / t7) ;
            fprintf (stdout, "speedup of BF_basic_mxv:   %g\n", t1/t7) ;
